...
В `plans.json` выставлена базовая сетка без годового обязательства:

- 1 устройство: `299 / 599 / 849 / 1499 RUB` (30/60/90/180 дней)
- 3 устройства: `349 / 699 / 999 / 1799 RUB`
- 5 устройств: `449 / 849 / 1249 / 2299 RUB`
- Для тарифов от `3` устройств добавлен скрытый апгрейд `+ доп. профиль`.
- Тарифы с обходом БС дороже базовых и доступны как отдельные публичные планы или скрытые апгрейды.
...
В текущем production `plans.json` для базового тарифа выставлено:
